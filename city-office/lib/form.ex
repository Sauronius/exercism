defmodule Form do
  @moduledoc "A collection of loosely related functions helpful for filling out various forms at the city office.\n"
  ...
  @doc "Formats the address as an uppercase multiline string.\n"
